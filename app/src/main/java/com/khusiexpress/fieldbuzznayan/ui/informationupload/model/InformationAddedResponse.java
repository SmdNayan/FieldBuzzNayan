...
public class InformationAddedResponse implements Serializable {
    ...
    @Expose
    private Object onSpotUpdateTime;
    @SerializedName("on_spot_creation_time")
    @Expose
    private Object onSpotCreationTime;
    ...
    public Object getOnSpotUpdateTime() {
    ...
    public Object getOnSpotCreationTime() {
